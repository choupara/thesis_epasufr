...
1. **Facet Count Computation**  
   epas can compute the *facet count* of answer sets that are **projected away**. Users need to use `#project` to indicate the set of projection atoms according to the encoding.
